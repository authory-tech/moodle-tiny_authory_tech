    ...
    var usersTable = {
        init: function(hasApiKey, enableReplay) {
            str
                ...
                .done(function() {
                    usersTable.getToken(hasApiKey, enableReplay);
                });
        },
        getToken: function(hasApiKey, enableReplay) {
            $('#page-mod-forum-discuss').find("article").get().forEach(function(entry) {
                ...
                com[0].done(function(json) {
                    ...
                    if (filepath) {
                        ...
                        myEvents.createModal(ids, context, '', replayInstances);
                        myEvents.analytics(ids, templates, context, '', replayInstances);
